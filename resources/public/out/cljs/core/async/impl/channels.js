...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16055 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16055 = (function (val,box,meta16056){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16055.cljs$lang$type = true;
cljs.core.async.impl.channels.t16055.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16055";
cljs.core.async.impl.channels.t16055.cljs$lang$ctorPrWriter = (function (this__8498__auto__,writer__8499__auto__,opt__8500__auto__){return cljs.core._write.call(null,writer__8499__auto__,"cljs.core.async.impl.channels/t16055");
});
cljs.core.async.impl.channels.t16055.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16055.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16057){var self__ = this;
var _16057__$1 = this;return self__.meta16056;
});
cljs.core.async.impl.channels.t16055.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16057,meta16056__$1){var self__ = this;
var _16057__$1 = this;return (new cljs.core.async.impl.channels.t16055(self__.val,self__.box,meta16056__$1));
});
cljs.core.async.impl.channels.__GT_t16055 = (function __GT_t16055(val__$1,box__$1,meta16056){return (new cljs.core.async.impl.channels.t16055(val__$1,box__$1,meta16056));
});
}
return (new cljs.core.async.impl.channels.t16055(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8501__auto__,writer__8502__auto__,opts__8503__auto__){return cljs.core._write.call(null,writer__8502__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8498__auto__,writer__8499__auto__,opt__8500__auto__){return cljs.core._write.call(null,writer__8499__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_16058 = self__.takes.pop();if((taker_16058 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16058))
{var take_cb_16059 = cljs.core.async.impl.protocols.commit.call(null,taker_16058);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16059,taker_16058,this$__$1){
return (function (){return take_cb_16059.call(null,null);
});})(take_cb_16059,taker_16058,this$__$1))
);
} else
{}
{
