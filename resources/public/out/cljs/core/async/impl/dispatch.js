...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16049 = (0);while(true){
var m_16050 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16050 == null))
{} else
{m_16050.call(null);
if((count_16049 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16051 = (count_16049 + (1));
count_16049 = G__16051;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7919__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7919__auto__)
