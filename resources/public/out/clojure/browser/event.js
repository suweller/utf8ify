...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj12970 = {};return obj12970;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__7919__auto__ = this$;if(and__7919__auto__)
...
{var x__8558__auto__ = (((this$ == null))?null:this$);return (function (){var or__7931__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__8558__auto__)]);if(or__7931__auto__)
{return or__7931__auto__;
} else
{var or__7931__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__7931__auto____$1)
...
return (function (p__12971){var vec__12972 = p__12971;var k = cljs.core.nth.call(null,vec__12972,(0),null);var v = cljs.core.nth.call(null,vec__12972,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__12973){var vec__12974 = p__12973;var k = cljs.core.nth.call(null,vec__12974,(0),null);var v = cljs.core.nth.call(null,vec__12974,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
