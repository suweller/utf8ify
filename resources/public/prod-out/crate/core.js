...
var html__delegate = function (tags){var res = cljs.core.map.cljs$core$IFn$_invoke$arity$2(crate.compiler.elem_factory,tags);if(cljs.core.truth_(cljs.core.second(res)))
{return res;
} else
...
html.cljs$lang$applyTo = (function (arglist__9226){
var tags = cljs.core.seq(arglist__9226);
