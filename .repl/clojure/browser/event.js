...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj12934 = {};return obj12934;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__5208__auto__ = this$;if(and__5208__auto__)
...
{var x__5847__auto__ = (((this$ == null))?null:this$);return (function (){var or__5220__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__5847__auto__)]);if(or__5220__auto__)
{return or__5220__auto__;
} else
{var or__5220__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__5220__auto____$1)
...
return (function (p__12935){var vec__12936 = p__12935;var k = cljs.core.nth.call(null,vec__12936,(0),null);var v = cljs.core.nth.call(null,vec__12936,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__12937){var vec__12938 = p__12937;var k = cljs.core.nth.call(null,vec__12938,(0),null);var v = cljs.core.nth.call(null,vec__12938,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
